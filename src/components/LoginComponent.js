...
import {Dimensions, Keyboard, Text, View, Platform, Image} from 'react-native';
import {
    Form,
    InputGroup,
    Input,
    ...
    render() {
        return (
            ...
            >
                ...
                <LinearGradient colors={[theme.mainColor, theme.secondColor]} style={styles.containerColorME}>
                    <View style={styles.contentColorME}>
                        <Image
                            style={{width: 2 * width / 3, height: width * 325 * 2 / (3 * 768)}}
                            source={require('../../assets/img/logo-alibaba.png')}
                        />
                    </View>
                </LinearGradient>
                }
